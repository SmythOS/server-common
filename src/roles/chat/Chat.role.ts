...
export class ChatRole extends BaseRole {
    ...
    constructor(
        ...
        options: {
            ...
            llmContextStore?: (req: express.Request) => ILLMContextStore;
    ...
    public async mount(router: express.Router): Promise<void> {
        ...
        router.get('/params', async (req, res) => {
            ...
            const isChatbotEnabled = agentData.usingTestDomain
                ? true
                : agentSettings?.get(CHATBOT_EMBODIMENT_TYPE.toLowerCase()) === 'true';
        ...
        router.get('/', async (req, res) => {
            ...
            const logo =
                agentSettings?.embodiments?.get(CHATBOT_EMBODIMENT_TYPE, 'icon') || 'https://proxy-02.api.smyth.ai/static/img/icon.svg';
