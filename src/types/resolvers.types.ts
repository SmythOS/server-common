 ...
 * };
 */
export type ModelResolver = Resolvable<string, { baseModel: string; planInfo: Record<string, any> }>;
 ...
 * };
 */
export type ServerOriginResolver = Resolvable<string, { req: express.Request }>;
